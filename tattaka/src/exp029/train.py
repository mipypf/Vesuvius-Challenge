...
EXP_ID = "029"
COMMENT = "2.5D + 3DCSN + no_mixup_epochs + channel shift + stochastic depth + mid_layer option + groups option + manifold mixup + SGD"
...
class InkDetLightningModel(pl.LightningModule):
    ...
    def configure_optimizers(self):
        self.warmup = True
        optimizer = SGD(self.get_optimizer_parameters(), momentum=0.9)
