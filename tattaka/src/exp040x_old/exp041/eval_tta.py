...
"""
resnetrs50_split3d5x7csn_mixup/fold1: score: 0.6174474211567622, threshold: 0.913476562500001
resnetrs50_split3d5x7csn_mixup/fold2: score: 0.6380420911191639, threshold: 0.913964843750001
resnetrs50_split3d5x7csn_mixup/fold3: score: 0.6255239777595943, threshold: 0.9343750000000011
resnetrs50_split3d5x7csn_mixup/fold4: score: 0.7167944886934213, threshold: 0.8904296875000008
resnetrs50_split3d5x7csn_mixup/fold5: score: 0.7082211069538888, threshold: 0.897851562500001

resnetrs50_split3d3x9csn_l6_mixup/fold1: score: 0.6070038943241042, threshold: 0.9000000000000009
resnetrs50_split3d3x9csn_l6_mixup/fold2: score: 0.6442222449657901, threshold: 0.897363281250001
resnetrs50_split3d3x9csn_l6_mixup/fold3: score: 0.664407613434466, threshold: 0.9294921875000011
resnetrs50_split3d3x9csn_l6_mixup/fold4: score: 0.7245335930136442, threshold: 0.8894531250000008
resnetrs50_split3d3x9csn_l6_mixup/fold5: score: 0.7221778728193652, threshold: 0.901660156250001
"""
...
def main(args):
    ...
    for i, valid_idx in enumerate(fragment_ids):
        ...
        for batch in tqdm(dataloader):
            ...
            with torch.no_grad():
                pred_batch = torch.sigmoid(model.model(volume)[0])
