...
python train.py --seed 2022 --drop_path_rate 0.2 --mixup_p 0.5 --mixup_alpha 0.2 --lr 1e-3 --backbone_lr 2e-4 --in_chans 2 --batch_size 16 --image_size 256 --start_z 16 --end_z -17 --shift_z 2 \
