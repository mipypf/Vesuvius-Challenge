python train.py --seed 2022 --model_name resnetrs50 --drop_path 0.4 --drop_path_rate 0.2 --num_3d_layer 3 --in_chans 5 \
    --mixup_p 0.5 --mixup_alpha 0.2  --lr 3e-4  --batch_size 8 --image_size 256 --start_z 15 --end_z -15 --shift_z 2 \
...
python train.py --seed 2022 --model_name resnetrs50 --drop_path 0.4 --drop_path_rate 0.2 --num_3d_layer 6 --in_chans 3 \
    --mixup_p 0.5 --mixup_alpha 0.2  --lr 3e-4  --batch_size 8 --image_size 256 --start_z 19 --end_z -19 --shift_z 2 \
...
# python train.py --seed 2022 --model_name tf_efficientnet_b1_ns --drop_path 0.4 --drop_path_rate 0.2 --num_3d_layer 3 --in_chans 5 \
#     --mixup_p 0.5 --mixup_alpha 0.2  --lr 3e-4  --batch_size 16 --image_size 256 --start_z 15 --end_z -15 --shift_z 2 \
...
# python train.py --seed 2024 --model_name tf_efficientnet_b1_ns --drop_path 0.4 --drop_path_rate 0.2 --num_3d_layer 3 --in_chans 5 \
#     --mixup_p 0.5 --mixup_alpha 0.2  --lr 3e-4  --batch_size 16 --image_size 256 --start_z 15 --end_z -15 --shift_z 2 \
...
# python train.py --seed 2022 --model_name tf_efficientnet_b1_ns --drop_path 0.4 --drop_path_rate 0.2 --num_3d_layer 6 --in_chans 3 \
#     --mixup_p 0.5 --mixup_alpha 0.2  --lr 3e-4  --batch_size 16 --image_size 256 --start_z 19 --end_z -19 --shift_z 2 \
...
# python train.py --seed 2024 --model_name tf_efficientnet_b1_ns --drop_path 0.4 --drop_path_rate 0.2 --num_3d_layer 6 --in_chans 3 \
#     --mixup_p 0.5 --mixup_alpha 0.2  --lr 3e-4  --batch_size 16 --image_size 256 --start_z 19 --end_z -19 --shift_z 2 \
