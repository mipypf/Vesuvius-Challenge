...
python train.py --seed 2032 --model_name resnext50d_32x4d --drop_rate 0.4 --drop_path_rate 0.2 --num_3d_layer 3 --in_chans 5 --mixup_p 0.5 --mixup_alpha 0.2 --lr 0.25e-3   --batch_size 16 --image_size 256 --start_z 15 --end_z -15 --shift_z 2 --fold 0 --gpus 1 --epochs 30 --logdir resnext50d_32x4d_split3d5x7csn_mixup_ep15 --num_workers 16
python eval_tta_fp16.py --seed 2032 --batch_size 16 --image_size 256 --fold 0 --logdir resnext50d_32x4d_split3d5x7csn_mixup_ep15 --num_workers 16