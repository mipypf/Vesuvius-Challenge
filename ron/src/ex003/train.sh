...
python train.py --seed 2022 --model_name swinv2_tiny_window8_256 --drop_rate 0.4 --drop_path_rate 0.2 --num_3d_layer 6 --in_chans 3 --mixup_p 0.5 --mixup_alpha 0.2 --lr 1e-4   --batch_size 8 --image_size 256 --start_z 19 --end_z -19 --shift_z 2 --fold 0 --gpus 1 --epochs 15 --logdir swinv2_tiny_window8_256_split3d3x9csn_l6_mixup_ep15 --num_workers 16
python eval_tta.py --seed 2022 --batch_size 8 --image_size 256 --fold 0 --logdir swinv2_tiny_window8_256_split3d3x9csn_l6_mixup_ep15 --num_workers 16
...
# python eval_tta_pp.py --seed 2022 --batch_size 16 --image_size 256 --fold 0 --logdir resnetrs50_split3d3x9csn_l6_mixup_ep30 --num_workers 16
...
# python eval_tta_pp.py --seed 3026 --batch_size 16 --image_size 256 --fold 4 --logdir resnetrs50_split3d3x9csn_l6_mixup_ep30 --num_workers 16
