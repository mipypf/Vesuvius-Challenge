...
python train.py --seed 2022 --model_name repvgg_b3g4 --drop_rate 0.4 --drop_path_rate 0.2 --num_3d_layer 6 --in_chans 3 --mixup_p 0.5 --mixup_alpha 0.2 --lr 1e-5   --batch_size 16 --image_size 256 --start_z 19 --end_z -19 --shift_z 2 --fold 0 --gpus 1 --epochs 15 --logdir repvgg_b3g4_split3d3x9csn_l6_mixup_ep15 --num_workers 16
python eval_tta_pp.py --seed 2022 --batch_size 16 --image_size 256 --fold 0 --logdir repvgg_b3g4_split3d3x9csn_l6_mixup_ep15 --num_workers 16
